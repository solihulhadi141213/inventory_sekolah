<?php
    ...
    //Buka Data Lama
    $class_level_old=GetDetailData($Conn,'kelas','id_kelas',$id_organization_class,'jenjang');
    $class_name_old=GetDetailData($Conn,'kelas','id_kelas',$id_organization_class,'kelas');
    ...
    // Update Data
    $UpdateData = mysqli_query($Conn,"UPDATE kelas SET 
        jenjang='$class_level',
        kelas='$class_name'
    WHERE id_kelas='$id_organization_class'") or die(mysqli_error($Conn)); 
    if($UpdateData){
