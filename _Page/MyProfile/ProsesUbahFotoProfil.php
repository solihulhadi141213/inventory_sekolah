<?php
    ...
    if (empty($SessionIdAccess)) {
        ...
        $ImageLama = GetDetailData($Conn, 'admin', 'id_admin', $SessionIdAccess, 'admin_image');
        ...
        if (empty($_FILES['image_akses']['name'])) {
            ...
            $UpdateFoto = mysqli_query($Conn,"UPDATE admin SET admin_image='$namabaru' WHERE id_admin='$SessionIdAccess'") or die(mysqli_error($Conn)); 
