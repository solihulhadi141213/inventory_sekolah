<?php
    ...
    if (!$Qry->execute()) {
        ...
        if(!empty($admin_image)){
            $image_url= ''.$base_url_with_path.'/image_proxy.php?dir=User&filename='.$admin_image;
        }else{
        ...
        echo '
            <div class="row mb-3 border-1 border-bottom">
                <div class="col-12 mb-3 text-center">
                    <img src="'.$image_url.'" alt="'.$admin_image.'" width="70%" class="rounded-circle">
                </div>
            </div>
        ';
        echo '
            ...
            <div class="row mb-2">
                ...
                <div class="col-2"><small>:</small></div>
                <div class="col-5">
                    <small class="text text-grayish">Admin</small>
                </div>
            </div>
        ';
    }
